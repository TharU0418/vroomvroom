...
<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-8 justify-center">
          {/* Card 1 */}
          <div 
         onClick={() => router.push(`/hire/one-time-drive?mode=lady`)}  
...
/>
          ...
          {/* Card 2 */}
          <div 
          onClick={() => router.push(`/hire/full-day-driver?mode=lady`)} 
          className="glass-container bg-white bg-opacity-40 rounded-xl p-2 h-full cursor-pointer hover:scale-105 transition-transform">
            <div className="relative h-64 rounded-lg overflow-hidden">
              <Image 
src="/hire2.jpg"
...
/>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/60 to-transparent">
                ...
                <p className="text-gray-200 font-small">Book a dedicated lady driver for several days or even weeks—perfect for short-term travel or business needs.</p>
              </div>
            </div>
          </div>
